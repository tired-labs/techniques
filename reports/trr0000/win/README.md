...
Event ID 232 captures the "network connection" event ([src](https://cdn-ak.f.st-hatena.com/images/fotolife/i/ici-blog/20250205/20250205212242.png)) (equivalent to plugging an Ethernet cable into a device, but virtually here). The below is a sample event, derived from [this troubleshooting article](https://clustering201.rssing.com/chan-5788003/all_p296.html) (search for 232).
